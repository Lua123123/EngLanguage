...
class FlipCardFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        {
            binding.cartFront3!!.text = it!!.success.get(1).word
            binding.cartBehind3!!.text = it!!.success.get(1).mean
        }
    ...
    private fun speak() {
        var text: String? = koinViewModel.mVocabulary.value?.success?.get(1)?.word
        if (text != null) {
            Log.d("TTS", text)
        }
